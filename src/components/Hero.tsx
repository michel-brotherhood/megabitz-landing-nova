      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 py-20 sm:py-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-0 text-center lg:text-left">
            ...
            {/* Desktop - Foto junto ao texto descritivo */}
            ...
            <div className="pt-4 sm:pt-6 lg:pt-0 lg:-mt-4 animate-fade-in flex justify-center lg:justify-start" style={{ animationDelay: '0.4s' }}>
              <a 
